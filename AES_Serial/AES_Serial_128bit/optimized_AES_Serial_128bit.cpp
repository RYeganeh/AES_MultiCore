...
void test_aes() {
    ...
    std::cout << "PLAINTEXT: " << AES128::bytes_to_hex(plaintext) << "\n\n";
    std::cout << "KEY: " << AES128::bytes_to_hex(key) << "\n\n";
    Key ciphertext = aes.encrypt_with_output(plaintext);
    ...
    if (ciphertext == expected_ciphertext) {
        std::cout << "\nCiphertext matches expected: " << AES128::bytes_to_hex(ciphertext) << '\n';
    } else {
        std::cout << "\nEncryption failed: " << AES128::bytes_to_hex(ciphertext)
                  << " != " << AES128::bytes_to_hex(expected_ciphertext) << '\n';
    }
}
